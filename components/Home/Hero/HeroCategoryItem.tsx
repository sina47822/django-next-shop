...
const HeroCategoryItem = ({id, url, label, iconurl,underline}: Props) => {
  ...
  return (
    <div key={id} className='space-y-2 cursor-pointer flex flex-col items-center'>
      <Link href={url}>
      <div className='pb-4 border-b-2 border-white hover:scale-[1.3] transition-all transition-shadow  dark:border-gray-950 opacity-60 hover:border-gray-200 hover:opacity-100'>
